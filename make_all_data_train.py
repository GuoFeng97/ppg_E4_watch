...
def subject_independent():
    ...
    subject_independent_data_dir = os.path.join(BASE_DIR, 'data', 'make_all_data_train_calculate_rest_5min')
    ...
    if exist(pathname=preprocessed_data_dir):
        ...
        for subject in all_subject_data:
            output_data = {
                'train': reduce(lambda feature_data_1, feature_data_2: merge(feature_data_1, feature_data_2), [all_subject_data[participant] for participant in all_subject_data ]),
                'test': {
